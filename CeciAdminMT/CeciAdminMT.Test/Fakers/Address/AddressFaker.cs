...
namespace CeciAdminMT.Test.Fakers.Address
{
    public static class AddressFaker
    {
        public static Faker<CeciAdminMT.Domain.Entities.Address> AddressEntity()
        {
            return new Faker<CeciAdminMT.Domain.Entities.Address>()
                .CustomInstantiator(p => new CeciAdminMT.Domain.Entities.Address
                {
                    Id = p.Random.Int(),
