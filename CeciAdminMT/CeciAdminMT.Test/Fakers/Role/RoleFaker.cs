...
namespace CeciAdminMT.Test.Fakers.Role
{
    public static class RoleFaker
    {
        public static Faker<CeciAdminMT.Domain.Entities.Role> RoleEntity()
        {
            return new Faker<CeciAdminMT.Domain.Entities.Role>()
                .CustomInstantiator(p => new CeciAdminMT.Domain.Entities.Role
                {
                    Active = true,
                    Id = p.Random.Int(1, 2),
                    Name = p.Random.Word(),
