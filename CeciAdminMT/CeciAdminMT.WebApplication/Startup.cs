...
using CeciAdminMT.WebApplication.Attribute;
using CeciAdminMT.WebApplication.Dependencys;
using CeciAdminMT.WebApplication.Extensions;
using CeciAdminMT.WebApplication.Filters;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                var xmls = new List<string>(new string[] { Path.Combine(AppContext.BaseDirectory, "CeciAdminMT.WebApplication.xml"),
                    Path.Combine(AppContext.BaseDirectory, "CeciAdminMT.Domain.xml") });
